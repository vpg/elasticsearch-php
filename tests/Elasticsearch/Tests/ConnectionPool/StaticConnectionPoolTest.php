...
class StaticConnectionPoolTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAddOneHostThenGetConnection()
    {
        ...
        /**
 * @var \Vpg\Elasticsearch\Connections\Connection[]&\Mockery\MockInterface[] $connections
*/
    ...
    public function testAllHostsFailPing()
    {
        ...
        $this->expectException(\Vpg\Elasticsearch\Common\Exceptions\NoNodesAvailableException::class);
